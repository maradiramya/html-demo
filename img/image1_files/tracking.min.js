...
b.iteratorPrototype=function(a){b.initSymbolIterator();a={next:a};a[b.global.Symbol.iterator]=function(){return this};return a};b.makeIterator=function(a){b.initSymbolIterator();var c=a[Symbol.iterator];return c?c.call(a):b.arrayIterator(a)};
...
b.iteratorFromArray=function(a,c){b.initSymbolIterator();a instanceof String&&(a+="");var d=0,e={next:function(){if(d<a.length){var f=d++;return{value:c(f,a[f]),done:!1}}e.next=function(){return{done:!0,value:void 0}};return e.next()}};e[Symbol.iterator]=function(){return e};return e};b.findInternal=function(a,c,d){a instanceof String&&(a=String(a));for(var e=a.length,f=0;f<e;f++){var g=a[f];if(c.call(d,g,f,a))return{i:f,v:g}}return{i:-1,v:void 0}};var l=l||{};l.global=this;
l.isDef=function(a){return void 0!==a};l.isString=function(a){return"string"==typeof a};l.isBoolean=function(a){return"boolean"==typeof a};l.isNumber=function(a){return"number"==typeof a};l.exportPath_=function(a,c,d){a=a.split(".");d=d||l.global;a[0]in d||!d.execScript||d.execScript("var "+a[0]);for(var e;a.length&&(e=a.shift());)!a.length&&l.isDef(c)?d[e]=c:d=d[e]&&d[e]!==Object.prototype[e]?d[e]:d[e]={}};l.define=function(a,c){l.exportPath_(a,c)};l.DEBUG=!0;l.LOCALE="en";l.TRUSTED_SITE=!0;
l.STRICT_MODE_COMPATIBLE=!1;l.DISALLOW_TEST_ONLY_CODE=!l.DEBUG;l.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING=!1;l.provide=function(a){if(l.isInModuleLoader_())throw Error("goog.provide can not be used within a goog.module.");l.constructNamespace_(a)};l.constructNamespace_=function(a,c){l.exportPath_(a,c)};l.VALID_MODULE_RE_=/^[a-zA-Z_$][a-zA-Z0-9._$]*$/;
...
l.debugLoader_=null;l.registerDebugLoader=function(a){if(l.debugLoader_)throw Error("Debug loader already registered!");if(!(a instanceof l.DebugLoader))throw Error("Not a goog.DebugLoader.");l.debugLoader_=a};l.getLoader_=function(){if(!l.debugLoader_&&l.DEBUG_LOADER)throw Error("Loaded debug loader file but no loader was registered!");l.debugLoader_||(l.debugLoader_=new l.DebugLoader);return l.debugLoader_};var p;l.DEBUG_LOADER&&(p=new l.DebugLoader,p.importScript_(l.basePath+l.DEBUG_LOADER));l.global.CLOSURE_NO_DEPS||
(p=p||new l.DebugLoader,l.DEBUG_LOADER||l.registerDebugLoader(p),p.importScript_(l.basePath+"deps.js"))};l.string={};l.string.DETECT_DOUBLE_ESCAPING=!1;l.string.FORCE_NON_DOM_HTML_UNESCAPING=!1;l.string.Unicode={NBSP:"\u00a0"};l.string.startsWith=function(a,c){return 0==a.lastIndexOf(c,0)};l.string.endsWith=function(a,c){var d=a.length-c.length;return 0<=d&&a.indexOf(c,d)==d};l.string.caseInsensitiveStartsWith=function(a,c){return 0==l.string.caseInsensitiveCompare(c,a.substr(0,c.length))};
...
l.math.sign=function(a){return 0<a?1:0>a?-1:a};l.math.longestCommonSubsequence=function(a,c,d,e){d=d||function(a,c){return a==c};e=e||function(c){return a[c]};for(var f=a.length,g=c.length,h=[],k=0;k<f+1;k++)h[k]=[],h[k][0]=0;for(var m=0;m<g+1;m++)h[0][m]=0;for(k=1;k<=f;k++)for(m=1;m<=g;m++)d(a[k-1],c[m-1])?h[k][m]=h[k-1][m-1]+1:h[k][m]=Math.max(h[k-1][m],h[k][m-1]);var n=[];k=f;for(m=g;0<k&&0<m;)d(a[k-1],c[m-1])?(n.unshift(e(k-1,m-1)),k--,m--):h[k-1][m]>h[k][m-1]?k--:m--;return n};
...
l.iter.zipLongest=function(a,c){var d=l.array.slice(arguments,1),e=new l.iter.Iterator;if(0<d.length){var f=l.array.map(d,l.iter.toIterator);e.next=function(){var c=!1,d=l.array.map(f,function(d){try{var e=d.next();c=!0}catch(n){if(n!==l.iter.StopIteration)throw n;e=a}return e});if(!c)throw l.iter.StopIteration;return d}}return e};l.iter.compress=function(a,c){var d=l.iter.toIterator(c);return l.iter.filter(a,function(){return!!d.next()})};
...
l.Uri.QueryData.prototype.extend=function(a){for(var c=0;c<arguments.length;c++)l.structs.forEach(arguments[c],function(a,c){this.add(c,a)},this)};function q(){this.cookies=new l.net.Cookies(document);this.cookieUri_=new l.Uri("/?"+this.cookies.get("APPS_MARKETING_SIGNALS"));this.currentUri_=new l.Uri(window.location.href);this.currentExperiment_=null;l.global.dataLayer[0].experimentID&&(this.currentExperiment_=l.global.dataLayer[0].experimentID);this.initMarketingSignals_()}
q.prototype.initMarketingSignals_=function(){this.cookies.get("APPS_MARKETING_SIGNALS")&&""!=this.cookies.get("APPS_MARKETING_SIGNALS")?this.updateMarketingSignals_():this.setMarketingSignalsCookie_(this.getLatestSourceValue_(),this.currentExperiment_,this.currentExperiment_)};
q.prototype.getLatestSourceValue_=function(){var a=null;this.currentUri_.getQueryData().get("source","")?a=this.currentUri_.getQueryData().get("source"):this.cookieUri_.getQueryData().get("source","")&&(a=this.cookieUri_.getQueryData().get("source"));return a};q.prototype.setMarketingSignalsCookie_=function(a,c,d){a||(a="");c||(c="");d||(d="");var e="."+this.currentUri_.getDomain();this.cookies.set("APPS_MARKETING_SIGNALS","source="+a+"&lastExperiment="+c+"&allExperiments="+d,3600,"/",e)};
q.prototype.setDataLayer_=function(a,c,d){var e=l.global.dataLayer;e[0].marketingSignals||l.object.extend(e[0],{marketingSignals:{source:"",exIdAll:"",exIdMostRecent:""}});e=e[0].marketingSignals;e.source=a;e.exIdMostRecent=c;e.exIdAll=d};
q.prototype.getAllExperiments_=function(){var a=this.cookieUri_.getQueryData().get("lastExperiment",""),c=this.cookieUri_.getQueryData().get("allExperiments","");this.currentExperiment_&&(""!=c&&this.currentExperiment_!=a?(c=[this.currentExperiment_,c].join(),a=c.split(","),l.array.removeDuplicates(a),c=a.join(",")):c||(c=this.currentExperiment_));return c};
q.prototype.updateMarketingSignals_=function(a){a=a?a:this.getLatestSourceValue_();var c=this.cookieUri_.getQueryData().get("lastExperiment");this.currentExperiment_&&(c=this.currentExperiment_);var d="";null!=this.getAllExperiments_()&&(d=this.getAllExperiments_());this.setDataLayer_(a,c,d);this.setMarketingSignalsCookie_(a,c,d)};q.prototype.getMarketingSignals=function(){return l.global.dataLayer[0].marketingSignals};
q.prototype.updateSourceInCookie=function(a){a=l.Uri.parse(a.target.href).getParameterValue("source")||"";this.updateMarketingSignals_(a)};l.Thenable=function(){};l.Thenable.prototype.then=function(){};l.Thenable.IMPLEMENTED_BY_PROP="$goog_Thenable";l.Thenable.addImplementation=function(a){a.prototype.then=a.prototype.then;a.prototype[l.Thenable.IMPLEMENTED_BY_PROP]=!0};l.Thenable.isImplementedBy=function(a){if(!a)return!1;try{return!!a[l.Thenable.IMPLEMENTED_BY_PROP]}catch(c){return!1}};l.async={};l.async.FreeList=function(a,c,d){this.limit_=d;this.create_=a;this.reset_=c;this.occupants_=0;this.head_=null};l.async.FreeList.prototype.get=function(){if(0<this.occupants_){this.occupants_--;var a=this.head_;this.head_=a.next;a.next=null}else a=this.create_();return a};l.async.FreeList.prototype.put=function(a){this.reset_(a);this.occupants_<this.limit_&&(this.occupants_++,a.next=this.head_,this.head_=a)};l.async.FreeList.prototype.occupants=function(){return this.occupants_};l.async.WorkQueue=function(){this.workTail_=this.workHead_=null};l.async.WorkQueue.DEFAULT_MAX_UNUSED=100;l.async.WorkQueue.freelist_=new l.async.FreeList(function(){return new l.async.WorkItem},function(a){a.reset()},l.async.WorkQueue.DEFAULT_MAX_UNUSED);l.async.WorkQueue.prototype.add=function(a,c){var d=this.getUnusedItem_();d.set(a,c);this.workTail_?this.workTail_.next=d:(l.asserts.assert(!this.workHead_),this.workHead_=d);this.workTail_=d};
...
l.debug.entryPointRegistry.unmonitorAllIfPossible=function(a){l.asserts.assert(a==l.debug.entryPointRegistry.monitors_[l.debug.entryPointRegistry.monitors_.length-1],"Only the most recent monitor can be unwrapped.");a=l.bind(a.unwrap,a);for(var c=0;c<l.debug.entryPointRegistry.refList_.length;c++)l.debug.entryPointRegistry.refList_[c](a);l.debug.entryPointRegistry.monitors_.length--};l.dom.HtmlElement=function(){};l.dom.TagName=function(a){this.tagName_=a};l.dom.TagName.prototype.toString=function(){return this.tagName_};l.dom.TagName.A=new l.dom.TagName("A");l.dom.TagName.ABBR=new l.dom.TagName("ABBR");l.dom.TagName.ACRONYM=new l.dom.TagName("ACRONYM");l.dom.TagName.ADDRESS=new l.dom.TagName("ADDRESS");l.dom.TagName.APPLET=new l.dom.TagName("APPLET");l.dom.TagName.AREA=new l.dom.TagName("AREA");l.dom.TagName.ARTICLE=new l.dom.TagName("ARTICLE");l.dom.TagName.ASIDE=new l.dom.TagName("ASIDE");
...
l.dom.TagName.STRONG=new l.dom.TagName("STRONG");l.dom.TagName.STYLE=new l.dom.TagName("STYLE");l.dom.TagName.SUB=new l.dom.TagName("SUB");l.dom.TagName.SUMMARY=new l.dom.TagName("SUMMARY");l.dom.TagName.SUP=new l.dom.TagName("SUP");l.dom.TagName.SVG=new l.dom.TagName("SVG");l.dom.TagName.TABLE=new l.dom.TagName("TABLE");l.dom.TagName.TBODY=new l.dom.TagName("TBODY");l.dom.TagName.TD=new l.dom.TagName("TD");l.dom.TagName.TEMPLATE=new l.dom.TagName("TEMPLATE");l.dom.TagName.TEXTAREA=new l.dom.TagName("TEXTAREA");
l.dom.TagName.TFOOT=new l.dom.TagName("TFOOT");l.dom.TagName.TH=new l.dom.TagName("TH");l.dom.TagName.THEAD=new l.dom.TagName("THEAD");l.dom.TagName.TIME=new l.dom.TagName("TIME");l.dom.TagName.TITLE=new l.dom.TagName("TITLE");l.dom.TagName.TR=new l.dom.TagName("TR");l.dom.TagName.TRACK=new l.dom.TagName("TRACK");l.dom.TagName.TT=new l.dom.TagName("TT");l.dom.TagName.U=new l.dom.TagName("U");l.dom.TagName.UL=new l.dom.TagName("UL");l.dom.TagName.VAR=new l.dom.TagName("VAR");l.dom.TagName.VIDEO=new l.dom.TagName("VIDEO");
l.dom.TagName.WBR=new l.dom.TagName("WBR");l.labs={};l.labs.userAgent={};l.labs.userAgent.util={};l.labs.userAgent.util.getNativeUserAgentString_=function(){var a=l.labs.userAgent.util.getNavigator_();return a&&(a=a.userAgent)?a:""};l.labs.userAgent.util.getNavigator_=function(){return l.global.navigator};l.labs.userAgent.util.userAgent_=l.labs.userAgent.util.getNativeUserAgentString_();l.labs.userAgent.util.setUserAgent=function(a){l.labs.userAgent.util.userAgent_=a||l.labs.userAgent.util.getNativeUserAgentString_()};
...
l.labs.userAgent.util.extractVersionTuples=function(a){for(var c=/(\w[\w ]+)\/([^\s]+)\s*(?:\((.*?)\))?/g,d=[],e;e=c.exec(a);)d.push([e[1],e[2],e[3]||void 0]);return d};l.labs.userAgent.browser={};l.labs.userAgent.browser.matchOpera_=function(){return l.labs.userAgent.util.matchUserAgent("Opera")};l.labs.userAgent.browser.matchIE_=function(){return l.labs.userAgent.util.matchUserAgent("Trident")||l.labs.userAgent.util.matchUserAgent("MSIE")};l.labs.userAgent.browser.matchEdge_=function(){return l.labs.userAgent.util.matchUserAgent("Edge")};l.labs.userAgent.browser.matchFirefox_=function(){return l.labs.userAgent.util.matchUserAgent("Firefox")};
...
l.dispose=function(a){a&&"function"==typeof a.dispose&&a.dispose()};l.disposeAll=function(a){for(var c=0,d=arguments.length;c<d;++c){var e=arguments[c];l.isArrayLike(e)?l.disposeAll.apply(null,e):l.dispose(e)}};l.debug.errorcontext={};l.debug.errorcontext.addErrorContext=function(a,c,d){a[l.debug.errorcontext.CONTEXT_KEY_]||(a[l.debug.errorcontext.CONTEXT_KEY_]={});a[l.debug.errorcontext.CONTEXT_KEY_][c]=d};l.debug.errorcontext.getErrorContext=function(a){return a[l.debug.errorcontext.CONTEXT_KEY_]||{}};l.debug.errorcontext.CONTEXT_KEY_="__closure__error__context__984382";l.labs.userAgent.platform={};l.labs.userAgent.platform.isAndroid=function(){return l.labs.userAgent.util.matchUserAgent("Android")};l.labs.userAgent.platform.isIpod=function(){return l.labs.userAgent.util.matchUserAgent("iPod")};l.labs.userAgent.platform.isIphone=function(){return l.labs.userAgent.util.matchUserAgent("iPhone")&&!l.labs.userAgent.util.matchUserAgent("iPod")&&!l.labs.userAgent.util.matchUserAgent("iPad")};l.labs.userAgent.platform.isIpad=function(){return l.labs.userAgent.util.matchUserAgent("iPad")};
...
l.debug.deepExpose=function(a,c){function d(a,k){var h=k+"  ";try{if(l.isDef(a))if(l.isNull(a))e.push("NULL");else if(l.isString(a))e.push('"'+a.replace(/\n/g,"\n"+k)+'"');else if(l.isFunction(a))e.push(String(a).replace(/\n/g,"\n"+k));else if(l.isObject(a)){l.hasUid(a)||f.push(a);var n=l.getUid(a);if(g[n])e.push("*** reference loop detected (id="+n+") ***");else{g[n]=!0;e.push("{");for(var v in a)if(c||!l.isFunction(a[v]))e.push("\n"),e.push(h),e.push(v+" = "),d(a[v],h);e.push("\n"+k+"}");delete g[n]}}else e.push(a);
else e.push("undefined")}catch(z){e.push("*** "+z+" ***")}}var e=[],f=[],g={};d(a,"");for(a=0;a<f.length;a++)l.removeUid(f[a]);return e.join("")};l.debug.exposeArray=function(a){for(var c=[],d=0;d<a.length;d++)l.isArray(a[d])?c.push(l.debug.exposeArray(a[d])):c.push(a[d]);return"[ "+c.join(", ")+" ]"};
...
l.string.Const.from=function(a){return l.string.Const.create__googStringSecurityPrivate_(a)};l.string.Const.TYPE_MARKER_={};l.string.Const.create__googStringSecurityPrivate_=function(a){var c=new l.string.Const;c.stringConstValueWithSecurityContract__googStringSecurityPrivate_=a;return c};l.string.Const.EMPTY=l.string.Const.from("");l.i18n={};l.i18n.bidi={};l.i18n.bidi.FORCE_RTL=!1;
...
l.dom.DomHelper.prototype.getAncestor=l.dom.getAncestor;l.dom.DomHelper.prototype.getCanvasContext2D=l.dom.getCanvasContext2D;function x(a){this.hasInstanceInternal_=!1;this.conf=a||{};this.pathname=window.location.pathname;window._gaq=window._gaq||[];this.trackClicks=!0;if(!1===this.conf.tracklinks||!1===this.conf.trackClicks)this.trackClicks=!1;this.conf.trackQueryParams&&(this.trackQueryParams=!0);this.isAdsDbCompatible_=void 0===this.conf.adsDbCompatible?!0:this.conf.adsDbCompatible;this.tracker=this.conf.tracker?this.conf.tracker+".":"";this.cookiePath=this.conf.cookiePath||this.getDynamicCookiePath_();this.cookiePathCopy=
this.conf.cookiePathCopy||[];this.prefix=this.conf.prefix||"";this.defaultEventName=this.conf.defaultEventName;this.defaultAction=this.conf.defaultAction;this.defaultLabel=this.conf.defaultLabel;this.setupAccount_(this.conf.profile);this.loadGaJs_();this.callOnDomReady(this.initListeners,this);this.conf.trackUnload&&this.addEvent(window,"unload",this.trackUnloadEvent,this);(this.trackEventCallback=this.conf.trackEventCallback)&&"function"!==typeof this.trackEventCallback&&(this.trackEventCallback=
void 0);this.hasInstanceInternal_=!0}x.prototype.hasInstance=function(){return this.hasInstanceInternal_};x.prototype.initListeners=function(){l.global.autotrackLinksEnabled||(l.global.autotrackLinksEnabled=!0,this.trackClicks&&this.initTrackClicks(),this.conf.heatMapper&&this.initHeatMapper_())};x.prototype.trackUnloadEvent=function(){this.trackEvent("AutoTrack: Navigation","Unload",window.location.href)};
x.prototype.initTrackClicks=function(){var a=this;this.addEvent(document.body,"click",function(c){c=c||window.event;c=c.target||c.srcElement;c=3==c.nodeType?c.parentNode:c;do{if(a.isTrackableTarget(c)){var d=a.getLabelText("eventname",c),e=a.getLabelText("action",c),f=a.getLabelText("label",c);a.trackEvent(d,e,f)}c.parentNode&&(c=c.parentNode)}while(c.parentNode)},this)};
x.prototype.initHeatMapper_=function(){var a=this;this.addEvent(document.body,"click",function(c){a.trackEvent("AutoTrack: Heatmap","Click",c.clientX+","+c.clientY)},this)};x.prototype.getDynamicCookiePath_=function(){return/^([^;,]*\/)/.exec(this.pathname)[0]};
x.prototype.setupAccount_=function(a){this.pushCommand([this.tracker+"_setAccount",a]);this.pushCommand([this.tracker+"_setCookiePath",this.cookiePath]);this.conf.domainName&&this.pushCommand([this.tracker+"_setDomainName",this.conf.domainName]);this.pushCommand([this.tracker+"_setAllowAnchor",!0]);this.isAdsDbCompatible_&&(window.location.hash||window.location.search)&&this.setAdsDbCompatible_();var c=this.conf.commands;if(c){a=0;for(var d;d=c[a];a++)d[0]=d[0]&&this.tracker+d[0],this.pushCommand(d)}if(this.cookiePathCopy)for(a=
...
x.prototype.loadGaJs_=function(){if(!window._gat){var a=l.dom.createElement("SCRIPT");a.type="text/javascript";a.async=!0;this.conf.cspNonce&&(a.nonce=this.conf.cspNonce);var c=l.html.TrustedResourceUrl.fromConstant(l.string.Const.from("https://ssl.google-analytics.com/ga.js"));l.dom.safe.setScriptSrc(a,c);c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(a,c)}};
x.prototype.isTrackableTarget=function(a){return!!("a"==a.nodeName.toLowerCase()||a.getAttribute("data-g-event")||a.getAttribute("data-g-action")||a.getAttribute("data-g-label"))};
x.prototype.setAdsDbCompatible_=function(){var a=window.location.href;this.pushCommand([this.tracker+"_setCampIdKey","cid"]);-1==a.indexOf("utm_campaign=")&&this.pushCommand([this.tracker+"_setCampNameKey","sourceid"]);-1==a.indexOf("utm_medium=")&&this.pushCommand([this.tracker+"_setCampMediumKey","medium"]);-1==a.indexOf("utm_source=")&&this.pushCommand([this.tracker+"_setCampSourceKey","subid"]);-1==a.indexOf("utm_term=")&&this.pushCommand([this.tracker+"_setCampTermKey","term"]);-1==a.indexOf("utm_content=")&&
this.pushCommand([this.tracker+"_setCampContentKey","content"])};x.prototype.trackEvent=function(a,c,d){this.prefix&&(d=this.prefix+d);this.pushCommand([this.tracker+"_trackEvent",a,c,d]);this.trackEventCallback&&this.trackEventCallback(a,c,d)};x.prototype.getDefaultEventNameForEl=function(a){return"a"==a.tagName.toLowerCase()?a.hostname==window.location.hostname?"AutoTrack: Link Click":"AutoTrack: Outbound Click":"AutoTrack: Element Click"};
x.prototype.getLabelText=function(a,c){return"eventname"==a?c.getAttribute("data-g-event")||this.normalizeText(this.defaultEventName,c)||this.getDefaultEventNameForEl(c):"action"==a?c.getAttribute("data-g-action")||this.normalizeText(this.defaultAction,c)||c.getAttribute("href")||"AutoTrack: Element Click":"label"==a?c.getAttribute("data-g-label")||this.normalizeText(this.defaultLabel,c)||this.pathname:""};
x.prototype.normalizeText=function(a,c){return"string"==typeof a?a:"function"==typeof a?a(c):""};x.prototype.addEvent=function(a,c,d,e){e&&(d=l.bind(d,e));if(a.addEventListener)a.addEventListener(c,d,!1);else if(a.attachEvent)return a.attachEvent("on"+c,d)};
x.prototype.callOnDomReady=function(a,c){c&&(a=l.bind(a,c));if(document.addEventListener)try{this.addEvent(document,"DOMContentLoaded",a,this)}catch(g){this.addEvent(window,"load",a,this)}else if(!document.uniqueID&&document.expando)var d=document.createElement("tempnode"),e=window.setInterval(function(){try{d.doScroll("left")}catch(g){return}window.clearInterval(e);e=d=null;c&&(a=l.bind(a,c));a()},50);else if("readyState"in document)var f=window.setInterval(function(){/loaded|complete/.test(document.readyState)&&
(window.clearInterval(f),f=null,c&&(a=l.bind(a,c)),a())},50);else this.addEvent(window,"load",a,this)};x.prototype.pushCommand=function(a){a instanceof Array&&window._gaq.push(a)};function y(a){x.call(this);this.conf=a||{};window.dataLayer=window.dataLayer||[];this.trackClicks=!0;this.callOnDomReady(this.initListeners,this);this.link_="";this.counter_=0;window.dataLayer=window.dataLayer||[];this.link_="";this.redirectTimer_=new l.Timer}b.inherits(y,x);y.prototype.initTrackClicks=function(){this.addEvent(document.body,"click",this.sendEvent_,this)};
y.prototype.sendEvent_=function(a){a=a||window.event;var c=a.target||a.srcElement;c=3==c.nodeType?c.parentNode:c;do{if(this.isTrackableTarget(c)){var d=this.getLabelText("eventname",c),e=this.getLabelText("action",c),f=this.getLabelText("label",c);this.link_=a.target.href;this.trackEvent(d,e,f,a)}c.parentNode&&(c=c.parentNode)}while(c.parentNode)};y.prototype.pushDatalayer_=function(a){a instanceof Object&&window.dataLayer.push(a)};
y.prototype.getSources=function(){return l.Uri.parse(window.location.href).getParameterValue("source")||""};y.prototype.trackEvent=function(a,c,d,e){var f=new q;f.updateSourceInCookie(e);l.events.listen(this.redirectTimer_,500,function(){this.redirectUser_(e)},!1,this);this.redirectTimer_.start();this.pushDatalayer_({"data-g-action":c,"data-g-event":a,"data-g-label":d,event:"autotrack-data-g",marketingSignals:f.getMarketingSignals(),eventCallback:this.redirectUser_(e)})};
y.prototype.redirectUser_=function(a){var c=/www\.youtube/.test(this.link_),d=/_blank/.test(a.target.target),e=/gweb-smoothscroll-control/.test(a.target.className);a=/gweb-tabset-anchor/.test(a.target.className);!this.link_||c||d||e||a||(l.dom.safe.setLocationHref(window.location.href,this.link_),this.link_="");this.redirectTimer_.stop()};l.exportSymbol("gsuite.components.analytics.AutoTrack",y);var A=l.string.Const.from("https://gsuite.google.com/js/components/utils/cookie-sharing.html?APPS_MARKETING_SIGNALS=%{APPS_MARKETING_SIGNALS}&_ga=%{_ga}&__utma=%{__utma}&__utmb=%{__utmb}&__utmc=%{__utmc}&__utmz=%{__utmz}"),B="APPS_MARKETING_SIGNALS _ga __utma __utmb __utmc __utmz".split(" ");function C(){this.cookies=new l.net.Cookies(document)}
C.prototype.sendCookies=function(){for(var a={},c=b.makeIterator(B),d=c.next();!d.done;d=c.next()){d=d.value;var e=0==d.indexOf("__")?this.replaceDomainId_(this.cookies.get(d)):this.cookies.get(d);a[d]=e}c=l.dom.createDom("IFRAME",{width:"1px",height:"1px",style:"display:none;visibility:hidden"});this.cookieIntakeUrl=l.html.TrustedResourceUrl.format(A,a);l.dom.safe.setIframeSrc(c,this.cookieIntakeUrl);document.body.appendChild(c)};l.exportProperty(C.prototype,"sendCookies",C.prototype.sendCookies);
C.prototype.getCookiesFromUrl=function(){for(var a=new l.Uri(window.location.href),c=b.makeIterator(B),d=c.next();!d.done;d=c.next())d=d.value,a.getQueryData().containsKey(d)&&"undefined"!=a.getQueryData().get(d)&&this.cookies.set(d,a.getQueryData().get(d),3600,"/",".gsuite.google.com")};l.exportProperty(C.prototype,"getCookiesFromUrl",C.prototype.getCookiesFromUrl);C.prototype.replaceDomainId_=function(a){return a.replace(/.*?\./,"183643312.")};l.exportSymbol("gsuite.components.analytics.hatsTracking",function(){var a=l.dom.getWindow();a._402=a._402||{};a._402.sc="page:"+document.location.host+document.location.pathname;a.dataLayer=a.dataLayer||[];a.dataLayer.push({event:"trackSurvey"})});new q;l.global.cookies=new C;}).call(window)
