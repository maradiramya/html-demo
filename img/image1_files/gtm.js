...
"resource": {
  ...
  "tags":[{
      ...
      "function":"__flc",
      "vtp_customVariable":["list",["map","key","u6","value",["macro",4]],["map","key","u11","value",["macro",78]],["map","key","u13","value",["macro",134]],["map","key","u14","value",["macro",23]],["map","key","u15","value",["macro",22]]],
      "vtp_enableConversionLinker":true,
      "vtp_groupTag":"googl003",
      "vtp_enableAttribution":false,
      "vtp_useImageTag":false,
      ...
      "vtp_nonInteraction":false,
      "vtp_useDebugVersion":false,
      "vtp_eventCategory":"G Suite: Link Fallback",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_functionName":"_ga",
      "vtp_gaSettings":["macro",92],
      "vtp_eventAction":["template",["macro",137]," link click"],
      "vtp_eventLabel":["macro",131],
      "vtp_useInternalVersion":false,
      "vtp_overrideGaSettings":true,
      "vtp_doubleClick":true,
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",89],
      "arg1":"lastExperiment=(6800966|6800967)\u0026",
      "ignore_case":true
    },{
      "function":"_re",
      "arg0":["macro",89],
  ...
  "rules":[
    ...
    [["if",4,14],["unless",13],["add",14,265,31,41,145,188]],
    ...
    [["if",29,51,52],["add",47]],
    [["if",29,31,52],["add",47]],
    [["if",2,53,54],["add",48,233,235]],
    [["if",1,31,55],["add",48,233,235]],
    [["if",2,31,56],["add",48,233,235]],
    [["if",44,57],["add",49]],
    [["if",1,58,59],["add",50]],
    [["if",1,60],["add",56]],
    [["if",1,61],["add",57]],
    ...
    [["if",29,157],["add",132,133,135,162,163,234]],
    ...
    [["if",1],["add",227,238,239,241,243,244,245,252,255,256,257,259,264]],
    [["if",237,238,239],["add",229]],
    [["if",1,237,238,241,242],["add",230]],
    [["if",1,243],["add",231]],
    [["if",1,244],["add",232]],
    [["if",12],["add",234],["block",183,184,185,186,187,188,189]],
    [["if",1,246,247],["add",236]],
    [["if",1,246,248],["add",236]],
    [["if",10,249,250,251],["add",237]],
    [["if",1,252],["add",240]],
    [["if",1,31,253],["add",242]],
    [["if",1,133],["add",246]],
    [["if",1,31,254],["add",247]],
    [["if",1,255],["add",248]],
    [["if",1,205],["add",253]],
    [["if",1,256],["add",254,258,262,263]],
    [["if",1,257],["add",260]],
    [["if",1,258],["add",261]],
    [["if",12],["unless",11],["block",13,14,15,16,17,18,26,27,28,29,265,30,161,162,163,166,167,188,189]],
    [["if",11,12],["block",31,128,129,130,131,132,133,134,135,136,137,138,139,140,142,143,144,145,146,147,148,150,151,152,153,154,155,156,157,158,159,190,191,195,196,197,198,199,200,216,218,219,220,221,222,223,224,236,237]],
    [["if",85,86],["block",77,78]],
    [["if",12,91],["block",82,83,84,85]],
    [["if",12,92],["block",85]],
    [["if",3,12],["block",128,130]],
    [["if",12,151],["block",128,130,132,134,136,138,140,143,154]],
    [["if",12,168],["block",140,142,143,144,197,236,237]],
    [["if",12,20,169],["block",140,142,143,144,154,155,156,157,197,198,236,237]],
    [["if",12,174],["block",145,146,147,190,191]],
    [["if",1,168],["block",164,165,186,187]],
    [["if",1],["unless",11],["block",164,165,186,187]],
    [["if",238,239,240],["block",229]],
    [["if",12,245],["block",233,234]]]
},
"runtime":[
[],[]
]
...
b){};var Y={a:{}};
Y.a.ctv=["google"],function(){(function(a){Y.__ctv=a;Y.__ctv.g="ctv";Y.__ctv.h=!0;Y.__ctv.b=0})(function(){return"542"})}();
...
Y.a.adm=["google"],function(){(function(a){Y.__adm=a;Y.__adm.g="adm";Y.__adm.h=!0;Y.__adm.b=0})(function(a){var b;b="//www.gstatic.com/adometry/collection/js/channel.js"+("#gid:"+L(a.vtp_groupId)+";advid:"+L(a.vtp_advertiserId)+";pid:"+L(a.vtp_placementId));for(var c=a.vtp_customVariables||[],d=[],e=0;e<c.length;e++){var g=c[e];d.push("cus."+L(g.name)+":"+L(g.value))}(d=d.join(";"))&&(b+=";"+d);H(b,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)})}();
...
J){void 0!==J&&(w+="&"+I+"="+J)}var t=ka,p=K("_gaq",[],!1),r=!1,v="";void 0==d.vtp_trackerName?v="gtm"+Jc()+".":""!==d.vtp_trackerName&&(v=d.vtp_trackerName+".");g("_setAccount","vtp_webPropertyId");e("_set","gtmid",bh(!0));g("_setCookiePath","vtp_cookiePath");m("page","vtp_page");g("_setDomainName","vtp_domainName");
...
k("_addIgnoredOrganic",d.vtp_ignoredOrganic);m("title","vtp_title");
var w="";
...
d.vtp_enableInPageLinkId&&e("_require","inpage_linkid","//www.google-analytics.com/plugins/ga/inpage_linkid.js");
g("_setCampContentKey","vtp_campContentKey");g("_setCampaignTrack",
"vtp_campaignTrack");g("_setClientInfo","vtp_clientInfo");g("_setDetectFlash","vtp_detectFlash");g("_setDetectTitle","vtp_detectTitle");
g("_setReferrerOverride","vtp_referrerOverride");
void 0!==d.vtp_forceSsl&&d.vtp_forceSsl&&(p.push(["_gat._forceSSL"]),r=!!d.vtp_forceSsl);l("_setCustomVar",function(I){for(var J=
[],Q=0;I&&Q<I.length;Q++){var S=I[Q];void 0!==S.value&&(S.slot=sa(S.slot),S.scope=n(sa,S.scope),J.push(S))}return J}(d.vtp_customVar),["slot","name","value","scope"]);e("_set","hitCallback",function(){ha(d.vtp_hitCallback)&&d.vtp_hitCallback();d.vtp_gtmOnSuccess()});if("TRACK_EVENT"==d.vtp_trackType){e("_trackEvent",String(d.vtp_eventCategory),String(d.vtp_eventAction),
...
d.vtp_trackType){}else if("DECORATE_LINK"==d.vtp_trackType){var T=Uh("gtm.element",1);T&&p.push(function(){var I=K("_gat"),J=I._getTrackerByName(v.slice(0,
-1)),Q=T.href;if(Q){var S=/(.*)([?&#])(?:__utma=.*__utmk=[^&]*)(?:&?)(.*)/.exec(Q);S&&3<=S.length&&(Q=S[1]+(S[3]?S[2]+S[3]:""));T.href=J._getLinkerUrl(Q,d.vtp_useHashDecorateLink);A(d.vtp_gtmOnSuccess)}});}else if("DECORATE_FORM"==d.vtp_trackType){}else e("_trackPageview");k("_cookiePathCopy",d.vtp_cookiePathCopy);
...
Y.a.gcs=["google"],function(){(function(a){Y.__gcs=a;Y.__gcs.g="gcs";Y.__gcs.h=!0;Y.__gcs.b=0})(function(a){try{var b=a.vtp_siteId;if(!K("_gtmgcs")){f._gtmgcs={};var c=D("https:","http:","//survey.g.doubleclick.net/async_survey?site="+L(b));H(c)}a.vtp_gtmOnSuccess()}catch(d){A(a.vtp_gtmOnFailure)}})}();
